...
// Turkish translation.
// by Deniz Gökduman https://github.com/gokdumano
var textStrings_TR = {
	// Act 1
	"niceHat": "OOO GÜZEL ŞAPKA" 															,
	"outtaHere": "burayı terket!"															,
	"getARoom": "AYIP, AİLE VAR BURADA"														,
	"notCoolAnymore": "neyse zaten şapkalar demode artık"									,
	"tvOnTv": "TV'de... BİR TV!"															,
	"cricky": "KÜÇÇÜK ÇEKİRGE <3"															,
	"tooManyCrickets": "tamam bu çok fazla çekirge"											,
	"normalPeep": "sade bir vatandaş"														,
	"normalPeeps": "sade vatandaşlar"														,
	"wowNothing": "Ooo, hiçbir şey"															,

	// Act 2
	"crazySquareAttacks": "ÇILGIN KARE SALDIRDI"											,
	"justMissed": "oooooh az farkla kaçırdın"												,
	"somethingInteresting": "(hepsini *ilginç* bi'şeyler yaparken yakalamalısın...)"		,
	"whoIsScreaming": "(bağıran kişiyi yakalamalısın)"										,
	"circleFearsSquares": "ÇEMBER KARELERDEN KORKUYOR"										,
	"whoScaresThem": "(kimden korkmuşlar onu da yakalamalısın)"								,
	"areTheyScared": "(kare tarafından korkutulduklarını yakalamalısın)"					, // not used
	"squaresSnubCircles": "KARELER ÇEMBERLERİ HOR GÖRÜYOR"									,
	"areTheySnubbed": "(bir çemberi hor görürlerken yakalamalısın)"							, // not used
	"everyoneHates": "HERKES HERKESTEN NEFRET EDİYOR!!1!"									,
	"almostEveryoneHates": "NEREDEYSE HERKES HERKESTEN NEFRET EDİYOR..."					,
	"squaresHateCircles": "KARELER ÇEMBERLERDEN NEFRET EDİYOR"								,
	"circlesHateSquares": "ÇEMBERLER KARELERDEN NEFRET EDİYOR"								,
	"areTheyYelling": "(birbirlerine bağırırlarken yakalamalısın)"							, // not used
	"nerdsNow": "ne yapıyor bu inekler şimdi"												,
	"schockedPeep": "bu vatandaş niye şaşırdı?"												,
	"whatever": "her neyse",

	// Act 3
	"ellipsis": ". . ."																		,
	"coolNoMore": "şapkalar demode oldu, duymadın mı??"										,
	"beScared": "KORK. SİNİRLEN."															,

	// MANIFESTO
	"manifesto": [
		//"sanki izleyiciler İYİ haber istiyorlar da"										,
		"kim *insanların iyi geçindiğini* izlemek ister ki?"								,
		"barış sıkıcı. şiddet reyting demektir."											,
		//"barış sıkıcı. şiddet tıklama demektir."											,
		"ve her hikayenin çatışmaya ihtiyacı vardır, yani..."								,
		//"...İZLEYİCİLERE İSTEDİKLERİNİ VER."												,
		"İZLEYİCİLERE İSTEDİKLERİNİ VER."
	],
	...
	// (bg_preload.png) Preload screen
	"playingTime": "oynanış süresi: 5 dakika"												,
	"warning": "uyarı: takip eden program\nzüppelik, kabalık ve toplu cinayet\n sahneleri içerir.\nizleyici tedbiri tavsiye edilir.",

	// (cam-instructions.png) Camera Instructions
	"pointAndClick": "GÖSTER & TIKLA"														,

	// (chyron3.png)
	"chyronNothing": "OOOO, BU *HİÇBİR ŞEY*"												,
	...
	// (credits0002.png)
	"manyThanks": "test oyucularına çok teşekkürler:"										,

	// (credits000[3,4,5,6].png)
	"patreonSupporters": "ve patreon destekçilerime:"										,

	// (credits0007.png)
	"lastButNotLeast": "son olarak,"														,

	// (credits0008.png)
	"thankYouForPlaying": "oyunu oynadığın için SANA teşekkürler!"							,

	// (preload_play.png)
	"playButton": "OYNA"																	,

	// (end_button.png) Post Credits
	"otherWorkButton": "diğer çalışmalarıma bakın"											,
	"buyCoffeeButton": "bana bir kahve ısmarlayın"											,
	"replayButton": "bu hengameyi tekrar oyna"												,
	...
	// (quote0002.png)
	"WBWWB": "Ne seyrettiysek o olduk."														,
	"WSOTATOTSU": "Önce biz aletlerimizi şekillendirdik sonra da aletler bizi."				,

	// (quote0003.png)
	"MarshallMcLuhan": "Marshall McLuhan"													,

	// (quote0004.png)
	"misatrributed": "(yanlış atfedilen)"													,
};
